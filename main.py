...
from comand_handler import router, animal, photo_animal
...
async def tell(message: types.Message):
    chat_id = '5105694851'  # chatid сотрудника
    sotrudnik = '@PurosangueSkillFactoryBot'
    chat_user = message.chat.username
    from comand_handler import animal
...
async def tell(message: types.Message):
    # Условная функция
    chat_id = '5105694851'
    from comand_handler import animal, photo_animal
